...
public class EmiConfig {
	...
	@Comment("Hide JEI's item list overlay while EMI is active. JEI remains loaded for mod recipes.")
	@ConfigValue("general.hide-jei-overlay")
	public static boolean hideJeiOverlay = true;
	...
	@Comment("Place the search bar at the bottom center of the screen (JEI-style), instead of aligned to a sidebar.")
	@ConfigValue("ui.center-search-bar")
	public static boolean centerSearchBar = false;

	@Comment("Show the search bar at the bottom of the screen while EMI is open.")
	@ConfigValue("ui.show-search-bar")
	public static boolean showSearchBar = true;

	@Comment("Width of the bottom search bar in pixels. 0 sizes automatically like JEI.")
	@ConfigValue("ui.search-bar-width")
	public static int searchBarWidth = 0;
